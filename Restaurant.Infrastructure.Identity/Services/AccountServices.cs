...
namespace Restaurant.Infrastructure.Identity.Services
{
    public class AccountServices : IAccountServices
    {
        ...
        private async Task<JwtSecurityToken> GenerateToken(ApplicationUser user)
        {
            ...
            var symetricSecurity = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(settings.Key));
            var signingCreditials = new SigningCredentials(symetricSecurity, SecurityAlgorithms.HmacSha256);
            ...
            var jwtSecurityToken = new JwtSecurityToken(
                ...
                claims: claims,
                expires: DateTime.UtcNow.AddMinutes(settings.DurantionInMinutes),
